            ...
            <div style="padding: 24px;">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-group" style="margin-bottom: 16px;">
                        ...
                        <input type="text" id="modal_email" name="email" class="form-control" placeholder="rino.f21@gmail.com" value="{{ old('email') }}" required autofocus style="font-size: 14px; padding: 11px 14px;">
                    </div>
